...
export function MobileNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-[var(--border)] bg-[var(--surface)]/95 px-2 py-2 backdrop-blur xl:hidden" aria-label="Нижняя навигация">
